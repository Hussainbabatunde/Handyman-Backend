...
const registerChatHandler = (io, socket) => {
    ...
    socket.on("get_chats", async (userId, callback) => {
        try {
    ...
    socket.on("register-for-calls", (data) => {
    ...
    socket.on("answer-call", (data) => {
        ...
        const answererUserId = socketToUser.get(socket.id);
    ...
    socket.on("reject-call", (data) => {
        ...
        const rejecterUserId = socketToUser.get(socket.id);
    ...
    socket.on("end-call", (data) => {
        ...
        const enderUserId = socketToUser.get(socket.id);
    ...
    // Check availability
    socket.on("check-call-availability", (data) => {
        const { targetUserId } = data;
        const target = users.get(targetUserId);
    ...
    // Set availability
    socket.on("set-call-availability", (data) => {
