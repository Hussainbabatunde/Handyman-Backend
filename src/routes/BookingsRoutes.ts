...
import { BookingDetailsController, completeBookingStatusController, createBookingsController, getAllBookingsController, updateBookingStatusController } from "../controllers/bookingsController";
